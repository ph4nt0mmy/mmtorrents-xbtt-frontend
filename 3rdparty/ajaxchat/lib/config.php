...
// Database username:
$config['dbConnection']['user'] = 'mm6';
// Database password:
$config['dbConnection']['pass'] = 'BFcHL73HqrSqzhEK';
// Database name:
$config['dbConnection']['name'] = 'mm6';
// Database type:
...
$config['langAvailable'] = array('en', 'hu');
// Default language:
$config['langDefault'] = 'hu';
// Language names:
