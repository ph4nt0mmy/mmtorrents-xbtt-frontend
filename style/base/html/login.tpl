...
<ul>
	...
	<input type="submit" id="submitButton" name="submitButton" value="<tag:login />" disabled="disabled">
     </p>
     </FORM>
    </li>
    <li class="right">
     <p><a class="not_logged_in" href="?mpage=reg"><tag:registration /></a>&nbsp;<tag:pipe />&nbsp;<a class="not_logged_in" href="?mpage=lostpwd"><tag:lostpasswd /></a>&nbsp;&nbsp;
